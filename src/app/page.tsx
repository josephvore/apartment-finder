          ...
          <li key={apt.id}>
            <Card className="p-4 flex flex-col gap-3 touch-card">
              <Link
                ...
                className="-m-1 p-1 rounded-md flex flex-col gap-2"
              >
                ...
                {apt.cons.length > 0 && (
                  <p className="text-sm text-rose-700 leading-snug line-clamp-2">
              ...
              <div className="flex items-center gap-2 pt-2 border-t border-slate-100">
                <Link
                  ...
                  className="px-3 min-h-[44px] inline-flex items-center rounded border border-slate-300 text-sm hover:bg-slate-50"
                >
                  Edit
                </Link>
                <div className="ml-auto flex items-center gap-1">
                  <button
                    ...
                    disabled={idx === 0}
                    className="w-11 h-11 inline-flex items-center justify-center rounded text-slate-500 disabled:opacity-30 hover:bg-slate-100"
                  >
                    <ChevronUp />
                  </button>
                  <button
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      if (confirm(`Delete ${apt.name}?`))
                        deleteApartment(apt.id);
                    }}
                    aria-label={`Delete ${apt.name}`}
                    className="w-11 h-11 inline-flex items-center justify-center rounded text-rose-600 hover:bg-rose-50"
                  >
                    <TrashIcon />
                  </button>
                </div>
