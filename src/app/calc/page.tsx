...
import { Card, RankBadge, fmtMoney } from "@/components/ui";
            ...
            <li key={apt.id}>
              <Card className="p-4 space-y-3">
                ...
                <dl className="grid grid-cols-2 gap-x-3 gap-y-1.5 text-sm tabular-nums">
                  ...
                  <dd className="text-right italic text-amber-700">
                    {fmtMoney(utilities)}
                  </dd>
                  <dt className="text-[var(--muted)] pt-1.5 border-t border-slate-100">
                    Move-in
                  </dt>
                  <dd className="text-right font-medium pt-1.5 border-t border-slate-100">
                    {fmtMoney(moveIn)}
                  </dd>
            ...
            {rows.map(
              ({ apt, rent, parking, pet, utilities, total, moveIn, cps }) => (
                ...
                >
                  ...
                  <td className="px-3 py-2 tabular-nums text-amber-700 italic">
                    {fmtMoney(utilities)}
                  </td>
